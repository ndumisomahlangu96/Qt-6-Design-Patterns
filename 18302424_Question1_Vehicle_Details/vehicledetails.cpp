...
QString VehicleDetails::model() const { return m_model; }

void VehicleDetails::setModel(const QString &model) { m_model = model; }

int VehicleDetails::year() const { return m_year; }
